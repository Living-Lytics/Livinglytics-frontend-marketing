...
export default function SignInForm({ onSuccess, onClose }) {
    ...
    try {
      ...
      if (result.ok) {
        ...
        if (onSuccess) {
          ...
          // Force page reload to refresh auth status in context
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      if (result.ok) {
        ...
        // Using email as userId since we don't have a separate ID from the API
        trackSignup('email', signUpEmail);
  ...
  const handleGoogleSignIn = () => {
    // Mark OAuth attempt in sessionStorage for success tracking after redirect
    sessionStorage.setItem('ll_oauth_pending', 'google');
    loginWithGoogle();
  };
